...
export const activePanelTabStore = writable<'tags' | 'bookmarks' | 'preferences'>('tags')
export const hideNegativePrioritiesStore = writable<boolean>(false)
export const showCheckedStore = writable<boolean>(false)
